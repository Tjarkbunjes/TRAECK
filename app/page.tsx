                  ...
                  {dayLabels.map((label, i) => {
                    ...
                    return (
                      <div key={i} className="flex-1 text-center space-y-1">
                        <div className={`h-7 rounded-[5px] flex items-center justify-center border ${kcal ? 'bg-[#1e1e1e] border-border' : 'bg-muted/20 border-transparent'}`}>
                          {kcal ? (
              ...
              <div>
                ...
                <div className="flex gap-1.5">
                  {dayLabels.map((label, i) => {
                    ...
                    return (
                      <div key={i} className="flex-1 text-center space-y-1">
                        <div className={`h-7 rounded-[5px] flex items-center justify-center border ${name ? 'bg-[#1e1e1e] border-border' : 'bg-muted/20 border-transparent'}`}>
                          {name ? (
